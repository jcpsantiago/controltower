          ...
          [:div {:class "ph3"}
           ...
           [:div {:class "flex flex-wrap-reverse w-90 w-80-ns mt5 center items-center"}
             ...
             [:div {:class "w-100 w-two-thirds-ns ph2 pr4-ns"}
              ...
              [:a {:href (str "https://slack.com/oauth/authorize?scope=commands&client_id=817564915318.803887856067&state="
                              slack-oauth-url-state)}
               [:img {:alt "Add to slack" :height 40 :width 139
                      :src "https://platform.slack-edge.com/img/add_to_slack.png"
                      :srcset "https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x"}]]]]
           [:footer {:class "w-100 pv4 ph3 ph5-m ph6-l moon-gray mt5"}
            [:small {:class "f6 db tc"} "©"
             [:span {:class "ttu b pr1"} "unlimited budget llc"]
             [:span {:class ""} "(not a real company, yet)"]]
